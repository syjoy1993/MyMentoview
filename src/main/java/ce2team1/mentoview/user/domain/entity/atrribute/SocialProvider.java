...
public enum SocialProvider {
    ...
    public static SocialProvider byValue(String provider) {
        switch (provider) {
            ...
            /*
             * Todo
             *  - SocialProviderNotSupportedException
             *  - : user.domain.exception
             *  - public class SocialProviderNotSupportedException extends RuntimeException {

                        public SocialProviderNotSupportedException(String provider) {
                            super("지원하지 않는 소셜 제공자입니다: " + provider);
                        }
                    }
             *  -
             *
